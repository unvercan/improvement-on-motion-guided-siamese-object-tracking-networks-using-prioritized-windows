...
__all__ = ['AdaptiveKalmanSiamDistinct']


class AdaptiveKalmanSiamDistinct(Tracker):
    def __init__(self, net_path=None):
        super(AdaptiveKalmanSiamDistinct, self).__init__('AdaptiveKalmanSiamDistinct', True)
        self.config = Config()
